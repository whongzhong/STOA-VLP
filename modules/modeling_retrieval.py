...
class CLIP4Clip(CLIP4ClipPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids, attention_mask, video, video_mask=None, objects = None, object_layer=[], attr_triple = None, attr_sim=False, insert_attr=False, replace_cls=False, phrase_fuse="None", object_fuse="attention", obj_cls_tuple=None, use_action = False, action_only=False):
        ...
        if object_fuse == "fusion":
            ...
            sequence_output, visual_output, text_tokens, object_tensors = self.get_sequence_visual_output(input_ids, token_type_ids, None ,video, video_mask, shaped=True, video_frame=video_frame, objects=objects, object_layer=object_layer, need_object_token=True, object_fuse=object_fuse)
            ...
            sequence_output, visual_output, text_tokens = self.get_sequence_visual_output(input_ids, token_type_ids, None ,video, video_mask, shaped=True, video_frame=video_frame, objects=objects, object_layer=object_layer)
        ...
        if phrase_fuse == 'fusion':
            ...
            attr_pairs_mask = video_mask.new_zeros(attr_pairs_label.shape).float()
        ...
        torch.distributed.barrier() # sync data
